...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                 ...
                 if (!isset($_SESSION['customer_email'])){
                     echo "<a class='nav-link' href='checkout.php'>حساب من</a>";
                 }else{
                      echo "<a class='nav-link' href='customer/my_account.php'>حساب من</a>";
                 }
        ...
        <form method="get" action="result.php" class="d-flex">
            <input class="form-control me-2" name="user_query" type="text" placeholder="Search" aria-label="Search">
            <input type="submit" name="search" class="btn btn-outline-success" value="جستجو" />
